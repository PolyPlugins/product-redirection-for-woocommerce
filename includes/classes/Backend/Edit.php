...
class Edit {
  ...
  public function init() {
    ...
    add_action('quick_edit_custom_box', array($this, 'add_edit_fields'), 10, 2);
    add_action('bulk_edit_custom_box', array($this, 'add_edit_fields'), 10, 2);
   ...
   * @return void
   */
  public function add_edit_fields($column_name, $post_type) {
    switch( $column_name ) {
      case 'enable_prfw': {
        ?>
